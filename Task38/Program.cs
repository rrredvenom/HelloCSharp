...
double [] NewArrayRandom(int size, int min, int max)
{
...
double[] array = NewArrayRandom(5, 100, 999);
PrintArray(array);
...
Console.Write($"Разница между max и min элементами массива: {Math.Round(result, 2)}");